...
authRouter.get('/verifyIdToken', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
...
authRouter.get('/getUserDetails', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, foundUser, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = req.currentUser;
...
authRouter.post('/doctorVerificationSubmission', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
authRouter.post('/updateAvatarImage', (0, celebrate_1.celebrate)((_a = {},
...
authRouter.post('/updateName', (0, celebrate_1.celebrate)((_b = {},
