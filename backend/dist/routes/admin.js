...
adminRouter.post('/approveDoctor', (0, celebrate_1.celebrate)((_a = {},
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_client_1.default.doctor.update({
                        where: {
                            uid: doctorUid
                        },
                        data: {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, app_1.bucket.file("images/identification/" + doctorUid).delete()
                        .catch(function (e) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, app_1.bucket.file("images/licenses/" + doctorUid).delete()
                        .catch(function (e) {
            ...
            case 3:
                ...
                return [2 /*return*/, res.status(200).send("User " + req.body.doctorUid + " approved as doctor")];
        }
    });
}); });
