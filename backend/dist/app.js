...
exports.stripe = exports.bucket = void 0;
...
var auth_2 = __importDefault(require("./routes/auth"));
...
exports.stripe = new stripe_1.default(process.env.STRIPE_SECRET_TEST_KEY, { apiVersion: '2020-08-27' });
app.use((0, cors_1.default)());
//NOTE: This has to come before bodyParser.json() so that stripe webhook route maintains raw body
app.use('/webhook', body_parser_1.default.raw({ type: "*/*" }));
...
app.use('/auth/admin', admin_1.default);
app.use('/auth/patient', patient_1.default);
app.use('/auth/doctor', doctor_1.default);
